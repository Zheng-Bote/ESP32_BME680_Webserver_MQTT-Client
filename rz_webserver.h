...
<html lang="en">
  ...
  <meta name="description" content="ESP32 BME680 Wifi Webserver & MQTT client">
  ...
  <div class="content">
    <div class="cards">
      ...
      <div class="card pressure">
        <h4><i class="fas fa-angle-double-down"></i> PRESSURE</h4><p><span class="reading"><span id="pres"><i class="fa fa-spinner fa-spin"></i></span> hPa</span></p>
      </div>
      <div class="card gas">
        <h4><i class="fas fa-wind"></i> GAS</h4><p><span class="reading"><span id="gas"><i class="fa fa-cog fa-spin fa-fw"></i></span> K&ohm;</span></p>
      </div>
    </div>
  </div>
  <script>
